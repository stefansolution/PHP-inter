...
<html lang="en">
	<head>
        ...
        <link rel="shortcut icon" href="{{url('/framework/public/')}}/assets/images/dealrated-fav-ico.png" type="image/x-icon">
        <link rel="icon" sizes="16x16 32x32 64x64" href="{{url('/framework/public/')}}/images/dealrated-fav-ico.png">
        <meta charset="utf-8">
        <link rel="stylesheet" href="{{url('/framework/public/')}}/assets/bootstrap/css/bootstrap.min.css">
        <script src="{{url('/framework/public/')}}/assets/js/jquery-3.4.1.min.js"></script>
        
        <script src="{{url('/framework/public/')}}/assets/bootstrap/js/bootstrap.min.js"></script>
        <script asyn src="{{url('/framework/public/')}}/assets/js/custom.js"></script>
        <link rel="stylesheet" href="{{url('/framework/public/')}}/assets/font-awesome/css/font-awesome.min.css">
        <link href="{{url('/framework/public/')}}/assets/css/style.css" rel="stylesheet" />
