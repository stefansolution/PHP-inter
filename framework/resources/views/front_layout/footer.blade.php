      ...
      <div class="modal-content">
        ...
        <div class="modal-header-deal">
          <div class="coupon-info-container">
           <img class="coupon-logo rounded-circle"  src="{{$assets_front}}/assets/images/wow.png">
    ...
    <div class="container pt-4">
	    <div class="row">
		    <div class="col-md-3 col-xs-12">
			    ...
			    <img src="{{$assets_front}}/assets/images/dealrated-logo3.png" />
		...
		<div class="row footer_bottom mt-4 pt-4 pb-3">
			...
			<div class="col-md-6 col-xs-12 p-0 text-right">
			    <ul class="p-0">
				    <li><a href="{{url('about')}}">About Dealrated</a></li>
