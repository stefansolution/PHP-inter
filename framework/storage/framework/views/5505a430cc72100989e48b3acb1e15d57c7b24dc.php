...
<!-- Navbar Start -->
        <header class="navbar navbar-fixed">
            ...
            <div class="navbar--header">
                <!-- Logo Start -->
                <a href="#" class="logo">
                   <span style="color:white"><center> <img width= "140px" src="<?php echo e(url('framework/public/assets/images/dealrated-logo3.png')); ?>" alt=""></center></span>
                </a>
                <!-- Logo End -->
                ...
                <ul class="nav">
                   ...
                   <!-- <li class="nav-item">
                    ...
                    <li class="nav-item dropdown nav--user online">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(url('/profile')); ?>"><i class="far fa-user"></i>Profile</a></li>
                            <li><a href="<?php echo e(url('/editProfile/'.$adminId)); ?>"><i class="fa fa-edit"></i>Edit Profile</a></li>
        ...
        <!-- Navbar End --><?php /**PATH /home/adsrwopw/dealrated.com/framework/app/Modules/Admin/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>