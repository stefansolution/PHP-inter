                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                   ...
                                   <!-- <p class="miniStats--caption text-blue">Monthly</p>-->
                                    ...
                                    <p class="miniStats--num text-blue"><?php echo e($stores); ?></p>
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                    ...
                                    <p class="miniStats--num text-green"><?php echo e($scraped_Stores[0]->total_Store); ?></p>
                                </div>
                            </div>
...
<?php echo $__env->make('Admin::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adsrwopw/dealrated.com/framework/app/Modules/Admin/resources/views/dashboard.blade.php ENDPATH**/ ?>