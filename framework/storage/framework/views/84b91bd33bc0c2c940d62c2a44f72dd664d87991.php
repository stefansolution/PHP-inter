                    ...
                    <div class="records--body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab01">
                                ...
                                <form id="add-store-form" action="<?php echo e(url('/stores')); ?>" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="url" placeholder="https://www.example.com" value="<?php echo e(old('special_url')); ?>" name="special_url" class="form-control">
                                        </div>
                                    </div>
                                    <div class=" form-group row">
...
<?php echo $__env->make('Admin::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adsrwopw/dealrated.com/framework/app/Modules/Admin/resources/views/stores/add_store.blade.php ENDPATH**/ ?>